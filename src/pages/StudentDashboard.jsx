...
${resume.projects.map(proj => `${proj.name}: ${proj.description}`).join('\n')}
  ...
  const checkBadges = () => {
    ...
    if (stats.completedCourses >= 1 && !badges.find(b => b.id === 'first-course')) {
      newBadges.push({ id: 'first-course', name: 'First Course Complete', icon: '🎓' })
    }
    if (stats.completedCourses >= 5 && !badges.find(b => b.id === 'five-courses')) {
      newBadges.push({ id: 'five-courses', name: 'Five Courses Master', icon: '⭐' })
    }
    if (stats.certificatesEarned >= 1 && !badges.find(b => b.id === 'certified')) {
      newBadges.push({ id: 'certified', name: 'Certified Learner', icon: '🏆' })
    }
    if (stats.learningStreak >= 7 && !badges.find(b => b.id === 'streak-7')) {
      newBadges.push({ id: 'streak-7', name: '7 Day Streak', icon: '🔥' })
    }
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-600 mt-1">{stats.completedCourses}</p>
                      </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-purple-600 mt-1">{stats.certificatesEarned}</p>
                      </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-orange-600 mt-1">{stats.learningStreak} days</p>
                      </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    >
                      ...
                      <div className="text-sm font-medium text-gray-900">Browse Courses</div>
                    </button>
                    <button
                    ...
                    >
                      <div className="text-2xl mb-2">📝</div>
                      <div className="text-sm font-medium text-gray-900">My Notes</div>
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-600 mt-1">{stats.totalHours} hrs</p>
                    </div>
                        ...
                        {[65, 70, 68, 75, 80, 85, 90].map((height, i) => (
                          <div key={i} className="flex-1 flex flex-col items-center">
                            <div
                              ...
                              style={{ height: `${height}%` }}
                            />
                            <span className="text-xs text-gray-600 mt-2">{['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][i]}</span>
                          </div>
                        ))}
                      </div>
                    </div>
